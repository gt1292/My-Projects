...
void man(char *name)
{
    ...
    else if (strcmp(name, "write") == 0)
    {
        ...
        printf("Usage : write File_name\n After this enter the data what we want to write\n");
    }
    ...
    while (1)
    {
        ...
        else if (count == 2)
        {
            ...
            else if (strcmp(command[0], "fstat") == 0)
            {
                ...
                if (ret == -1)
                {
                    printf("ERROR : incorrect parmeter\n");
                }
                if (ret == -2)
                {
                    printf("ERROR : there is no such file\n");
        ...
        else if (count == 3)
        {
            if (strcmp(command[0], "create") == 0)
            {
                ...
                if (ret >= 0)
                    printf("File is created with file descriptor :%d\n", ret);
                if (ret == -1)
                    printf("ERROR : incorrect parameter\n");
                if (ret == -2)
            ...
            else if (strcmp(command[0], "read") == 0)
            {
                ...
                if (ret == -2)
                    printf("ERROR :permission denied\n");
                if (ret == -3)
                    printf("ERROR :reched at the end of file\n");
                if (ret == -4)
